              ...
              {filteredCategories.map((cat) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center">
                    <span className="inline-flex items-center rounded-full bg-indigo-50 dark:bg-indigo-900/30 px-2.5 py-0.5 text-[10px] font-black text-indigo-600 dark:text-indigo-400 ring-1 ring-indigo-600/20 dark:ring-indigo-400/20 ring-inset">
                      {cat._count.posts} 記事
                    </span>
                  </td>
                  <td className="px-6 py-4 text-center">
